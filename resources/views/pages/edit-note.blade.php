...
@section('content')
    ...
    @if($status == 'success')
        <form id="new-note-form"
              class="transition-all ease-in-out duration-1000 overflow-hidden mt-4 new-note-container bg-white rounded-lg ">
            <div class="p-4">
                ...
                <div class="flex items-center">
                    ...
                    <div class="relative">
                        <div class="flex items-center py-2 sm:py-1 px-2 rounded-full bg-blue-50 options">
                            ...
                            <div class="note-color h-6 w-6 rounded-full" style="background-color: {{ $colors->find($note->color)->color }}"></div>
